...
const ManageCareers = () => {
  ...
  const fetchJobs = async () => {
    setLoading(true);
    try {
      const response = await axios.get("http://localhost:4001/api/auth/jobs/list?page=1&limit=5");
      ...
      {viewJobDetails && selectedJob && (
        <div className="mt-6 p-6 bg-white rounded-lg shadow-lg border border-gray-200">
          ...
          <p className="text-lg text-gray-500 mb-4">
            Below are the details of the job you have selected. You can view the job description,
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center space-x-4 bg-gray-50 p-4 rounded-lg shadow-sm border-l-4 border-indigo-500">
              <span className="font-medium text-gray-700 text-xl w-32">Location:</span>
            ...
            {/* Category */}
            <div className="flex items-center space-x-4 bg-gray-50 p-4 rounded-lg shadow-sm border-l-4 border-indigo-500">
              <span className="font-medium text-gray-700 text-xl w-32">Category:</span>
              <span className="text-gray-600 text-lg">{selectedJob.category}</span>
            </div>

            {/* Description */}
            <div className="flex items-center space-x-4 bg-gray-50 p-4 rounded-lg shadow-sm border-l-4 border-indigo-500">
              <span className="font-medium text-gray-700 text-xl w-32">Description:</span>
