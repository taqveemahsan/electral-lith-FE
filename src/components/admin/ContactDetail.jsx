...
const ContactDetail = () => {
  ...
  return (
    <div className="container mx-auto p-6">
      <h2 className="text-3xl font-semibold text-center text-indigo-700 mb-8">Contact Details</h2>
      {loading ? (
        ...
        <div className="bg-white p-8 rounded-lg shadow-xl max-w-4xl mx-auto">
          <div className="flex flex-col space-y-6">
            ...
            <p className="text-xl text-gray-700">
              Email: <span className="font-normal text-gray-500">{contact.email}</span>
            </p>
            <p className="text-xl text-gray-700">
              Message: <span className="font-normal text-gray-500">{contact.message}</span>
            </p>
